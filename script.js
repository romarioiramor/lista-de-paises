...
async function fetchCountries() {
  ...
  allCountries = json.map((country) => {
    const { numericCode, name: translations, population, flag } = country;

    return {
      id: numericCode,
      name: translations,
      population,
      formatterdPopulation: formatNumber(population),
      flag,
    };
  });
...
function renderCountryList() {
  ...
  allCountries.forEach((country) => {
    const { name, flag, id, population, formatterdPopulation } = country;
